...
local function drawHelp()
    ...
    drawText(0.015, 0.085, '/mleft /mright /mforward /mback = ajuste fino | /mexport = exportar', 0.32)
end
...
RegisterKeyMapping('mplace', 'Colocar el prop actual', 'keyboard', 'E')
RegisterKeyMapping('mdelete', 'Borrar el prop apuntado', 'keyboard', 'BACK')
...
local hit = editor.lastHit ~= nil
local coords = editor.lastHit
